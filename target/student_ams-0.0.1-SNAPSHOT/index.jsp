<%@ page import="cn.goodym.entity.Course" %>
    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/adminIndex">管理员登录</a></li>
            </ul>
            <%
                if (id != null) {
            %>
    ...
    <div class="alert alert-success" style="margin-top: 50px" role="alert">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="./<%=clz.getImgurl()%>" width="360px" height="220px">
                    <h2><%=clz.getName()%>
                    </h2>
                    ...
                    <p><a class="btn btn-default" href="/showDetail?id=<%=clz.getId()%>" role="button">查看
                        详情 &raquo;</a></p>
                </div>
                <%
                        }
